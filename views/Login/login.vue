	...
	<div>
		<el-form :model="form" status-icon :rules="rules" ref="form" label-width="100px" class="login-container">
			...
			<el-form-item label="用户名" label-width="80px" prop="manager_id" class="manager_id">
				<el-input type="input" v-model="form.manager_phone" autocomplete="off" placeholder="请输入账号"></el-input>
			</el-form-item>
			<el-form-item label="密码" label-width="80px" prop="password">
				<el-input type="password" v-model="form.manager_password" placeholder="请输入密码"></el-input>
			</el-form-item>
		...
		methods: {
			login() {
				adminLogin(this.form).then((res) => {
					...
					this.$admin.state.cityName = CodeToText[res.data.data.city_code]
					this.$admin.state.cityCode = res.data.data.city_code;
				})
